...
/*
	Ici on affiche les concert dont le lieu n'est pas spécifié
*/
...
/*
	On créé un petit plugin qui permet d'afficher
	le nombre de concert n'ayant pas de lieu et
	le nombre de concert qui ne sont pas au Bénin, Congo ou Niger
*/
...
/*
	Ici, on va chercher les coordonnées chez GoogleMaps
*/
